    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dislike_users', models.ManyToManyField(blank=True, related_name='dislike_posts', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('dislike_users', models.ManyToManyField(blank=True, related_name='dislike_comments', to=settings.AUTH_USER_MODEL)),
